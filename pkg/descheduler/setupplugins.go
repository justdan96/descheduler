...
import (
	...
	"sigs.k8s.io/descheduler/pkg/framework/plugins/removepodsviolatingnodeconditions"
...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(removepodsviolatingnodeconditions.PluginName, removepodsviolatingnodeconditions.New, &removepodsviolatingnodeconditions.RemovePodsViolatingNodeConditions{}, &removepodsviolatingnodeconditions.RemovePodsViolatingNodeConditionsArgs{}, removepodsviolatingnodeconditions.ValidateRemovePodsViolatingNodeConditionsArgs, removepodsviolatingnodeconditions.SetDefaults_RemovePodsViolatingNodeConditionsArgs, registry)
